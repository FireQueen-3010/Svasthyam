...
<body>
    ...
    <header>
        ...
        <div class="content">
            ...
            <button class="btn-get"><a href="login-system/register.php">Get Started</a></button>
        </div>
    </header>
    <!-- Start Services -->
    <section id="services">
        ...
        <div class="container">
            <div class="box">
                ...
                <div class="info">
                   ...
                   <button class="btn-get"><a href="motivation.php">More</a></button>
                </div>
            </div>
            <div class="box">
                ...
                <div class="info">
                    ...
                    <button class="btn-get"><a href="workout.php">More</a></button>
                </div>
            </div>
            <div class="box">
                ...
                <div class="info">
                    ...
                    <button class="btn-get"><a href="findfriends.php">More</a></button>
                </div>
            </div>
            <div class="box">
